  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await axios.post(
        "https://global-hrm-mobile-server.vercel.app/auth/login",
        {
          email,
          password,
        }
  ...
  return (
    <View style={[t.flex1, t.bgGray100, t.itemsCenter, t.justifyCenter, t.pX4]}>
      <Image
        ...
        style={[t.h24, t.w24, t.mB6]}
      />
      <Text style={[t.text2xl, t.fontBold, t.textGray700, t.mB6]}>Login</Text>

      {error && (
        <Text style={[t.textRed500, t.textCenter, t.mB4]}>{error}</Text>
      )}
      ...
      <TouchableOpacity onPress={() => setIsForgotPasswordOpen(true)}>
        <Text style={[t.textOrange500, t.textSm, t.underline]}>
          Forgot Password?
        </Text>
      </TouchableOpacity>
